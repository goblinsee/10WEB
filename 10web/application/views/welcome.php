    ...
    <div class="am-collapse am-topbar-collapse" id="collapse-head">
      <ul class="am-nav am-nav-pills am-topbar-nav">
        ...
        <li class="am-dropdown" data-am-dropdown>
          ...
          <span class="am-icon-caret-down">导航栏</span>
          </a>
          <ul class="am-dropdown-content">
            <li class="am-dropdown-header">标题</li>
            <li><a href="#">1. 社团简介</a></li>
            <li><a href="#">2. 活动内容</a></li>
            <li><a href="#">3. 生活服务</a></li>
            <li><a href="#">4. 技术文章</a></li>
          </ul>
        </li>
      </ul>
...
<div class="get">
  <div class="am-g">
    <div class="am-u-lg-12">
      <h1 class="get-title">最新活动就放在这块蓝色的下面</h1>
      ...
      <p>
        <a href="http://amazeui.org" class="am-btn am-btn-sm get-btn">点击图片登录√</a>
      </p>
    </div>
  </div>
</div>
...
<div class="hope">
  <div class="am-g am-container">
    ...
    <div class="am-u-lg-8 am-u-md-6 am-u-sm-12">
      <h2 class="hope-title">与亿灵一起畅游在10的海洋</h2>
